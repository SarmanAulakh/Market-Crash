...
class Notifications extends Component {
  ...
  render() {
    ...
    const unReadNotifications = notifications.filter((not) => not.read === false).length

    if (notifications && unReadNotifications > 0) 
      notificationsIcon = <Badge badgeContent={unReadNotifications}color="secondary"><NotificationsIcon /></Badge>
    else 
